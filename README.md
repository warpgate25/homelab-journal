...
| **02** | **Docker & Containers** | Containerization, Isolation, Container Log Inspection | ![Completed](https://img.shields.io/badge/Status-Completed-success?style=flat-square) | [`Read Report`](docs/02-docker-basics.md) |
...
* **Analysis & CLI:** Bash, `journalctl`, `grep`, `awk`, `cut`, `sort`, `uniq`, `wc`
